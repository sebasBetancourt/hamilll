...
import type { LinkCard as LinkCardType, Language } from "@/modules/landing/domain/types";
...
// ── Icon registry ── SVG icons keyed by card.icon / card.id
const ICONS: Record<string, React.ReactNode> = {
  adeptos: (
    // Lightning bolt — matches Adeptos logo motif
  ...
  tiktok: (
    <svg viewBox="0 0 24 24" fill="currentColor" width={18} height={18}>
      <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.29 6.29 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.79 1.54V6.75a4.85 4.85 0 01-1.02-.06z" />
    </svg>
  ),
  youtube: (
    <svg viewBox="0 0 24 24" fill="currentColor" width={18} height={18}>
...
export default function LinkCard({ card, lang, index }: Props) {
  const icon = ICONS[card.icon] ?? ICONS[card.id];
